...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_outputwindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 34, 23)
    ...
    "outputwindow\0on_closeapp_clicked\0\0"
    "on_solveanother_clicked\0"
};
...
void outputwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        outputwindow *_t = static_cast<outputwindow *>(_o);
        switch (_id) {
        case 0: _t->on_closeapp_clicked(); break;
        case 1: _t->on_solveanother_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject outputwindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_outputwindow.data,
      qt_meta_data_outputwindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_outputwindow.stringdata))
        return static_cast<void*>(const_cast< outputwindow*>(this));
